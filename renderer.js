...
function refreshAvailableFirmwares()
{
	...
	//  request.get('http://speeduinobr.000webhostapp.com/fw/versions', {timeout: 20000}, function (error, response, body) 
	  request.get('https://raw.githubusercontent.com/speeduinobr/speeduinoFW/main/versions', {timeout: 20000}, function (error, response, body) 
    {
...
function refreshBasetunes()
{
    ...
    if(basetuneList === undefined || basetuneList.length == 0)
    {
        ...
        //var url = "https://github.com/speeduino/Tunes/raw/main/index.json";
		 var url = "http://github.com/speeduinobr/Tunes/raw/main/index.json";
...
function downloadHex(board)
{
    ...
    switch(board) {
      ...
      case "ATMEGA2560":
		...
		DLurl = "https://raw.githubusercontent.com/speeduinobr/speeduinoFW/main/" + e.options[e.selectedIndex].value + ".hex";
...
function downloadIni()
{
	...
	var DLurl = "https://raw.githubusercontent.com/speeduinobr/speeduinoFW/main/" + e.options[e.selectedIndex].value + ".ini";
...
function downloadBasetune()
{
  ...
  var DLurl = "https://raw.githubusercontent.com/speeduinobr/Tunes/main/" + basetuneOption.dataset.make + "/" + basetuneOption.dataset.filename;
  console.log("Downloading: " + DLurl);
...
window.onload = function () {
    ...
    document.getElementById('title').innerHTML = "SpeeduinoBR Universal Firmware Loader (v" + remote.app.getVersion() + ")"
