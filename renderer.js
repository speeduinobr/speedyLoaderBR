...
function refreshBasetunes()
{
    ...
    if(basetuneList === undefined || basetuneList.length == 0)
    {
        ...
        //var url = "https://speeduino.com/fw/basetunes.json"
	         var url = "http://speeduinobr.000webhostapp.com/Tunes/index.json";
...
function refreshBasetunesFilters()
{
  ...
  for (var tune in basetuneList) 
  {
      ...
      if(AuthorBool && MakeBool && TypeBool)
      {
		  ...
		  newOption.style.background = "#000000";
...
function downloadHex(board)
{
    ...
    switch(board) {
      ...
      case "TEENSY41":
        ...
        break;
      case "ATMEGA2560":
        DLurl = "http://speeduinobr.000webhostapp.com/fw/bin/" + e.options[e.selectedIndex].value + ".hex";
...
function downloadIni()
{
    ...
    var e = document.getElementById('versionsSelect');
    var DLurl = "http://speeduinobr.000webhostapp.com/fw/" + e.options[e.selectedIndex].value + ".ini";
...
function downloadBasetune()
{
  ...
  //var DLurl = "http://speeduinobr.000webhostapp.com/Tunes/" + version + "/reference/Base%20Tunes/" + e.options[e.selectedIndex].value;
   var DLurl = "http://speeduinobr.000webhostapp.com/Tunes/" + basetuneOption.dataset.make + "/" + basetuneOption.dataset.filename;
...
function uploadFW()
{
    ...
    ipcRenderer.on("upload completed", (event, code) => {
        statusText.innerHTML = "Upload completado com sucesso!";
    ...
    ipcRenderer.on("upload error", (event, code) => {
        statusText.innerHTML = "Upload para o Speeduino falhou!!!";
